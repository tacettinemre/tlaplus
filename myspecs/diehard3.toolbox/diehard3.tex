...
\fl{}\moduleLeftDash\cl{ {\MODULE} diehard3}\moduleRightDash\cl{}
\fl{ {\EXTENDS} Integers}
\fl{ {\VARIABLES} small ,\, big}
\fl{}
 \fl{ TypeOK \.{\defeq}}\al{4}{2}{ \.{\land}}\al{4}{3}{ small \.{\in} 0
 \.{\dotdot} 3}
\fl{ \.{\land}}\al{5}{1}{ big \.{\in} 0 \.{\dotdot} 5}
\fl{ Init \.{\defeq} ( big \.{=} 0 \.{\land} small \.{=} 0 )}
\fl{}
 \fl{ FillSmall \.{\defeq} ( small \.{'} \.{=} 3 \.{\land} big \.{'} \.{=} big
 )}
 \fl{ FillBig \.{\defeq} ( big \.{'} \.{=} 5 \.{\land} small \.{'} \.{=} small
 )}
 \fl{ SmallToBig}\al{10}{1}{ \.{\defeq}}\al{10}{2}{ {\IF} big \.{+} small
 \.{\leq} 5%
\@y{\@s{0}%
 smalldan bige döktüğüm su bigi taşırmadı
}%
}
 \fl{ \.{\THEN} ( big \.{'}}\al{11}{4}{ \.{=}}\al{11}{5}{ big \.{+} small )
 \.{\land} small \.{'} \.{=} 0}
 \fl{ \.{\ELSE} ( big \.{'}}\al{12}{4}{ \.{=}}\al{12}{5}{ 5 \.{\land} small
 \.{'} \.{=} small \.{-} big )%
\@y{\@s{0}%
 taşırdı
}%
}
 \fl{ BigToSmall}\al{13}{1}{ \.{\defeq}}\al{13}{2}{ {\IF} small \.{+}
 big}\al{13}{6}{ \.{\leq} 3}
 \fl{ \.{\THEN} ( small \.{'}}\al{14}{4}{ \.{=} small \.{+} big ) \.{\land}
 big \.{'} \.{=} 0}
 \fl{ \.{\ELSE} ( small \.{'}}\al{15}{4}{ \.{=} 3 ) \.{\land} big \.{'} \.{=}
 big \.{-} small}
 \fl{ EmptySmall}\al{16}{1}{ \.{\defeq} ( small \.{'} \.{=} 0 ) \.{\land} big
 \.{'} \.{=} big}
 \fl{ EmptyBig \.{\defeq} ( big \.{'} \.{=} 0 ) \.{\land} small \.{'} \.{=}
 small}
\fl{ Next \.{\defeq}}\al{18}{2}{ \.{\lor}}\al{18}{3}{ FillSmall}
\fl{ \.{\lor}}\al{19}{1}{ FillBig}
\fl{ \.{\lor}}\al{20}{1}{ EmptySmall}
\fl{ \.{\lor}}\al{21}{1}{ EmptyBig}
\fl{ \.{\lor}}\al{22}{1}{ SmallToBig}
\fl{ \.{\lor}}\al{23}{1}{ BigToSmall}
\fl{}\bottombar\cl{}
\fl{}
\fl{}
\fl{}
